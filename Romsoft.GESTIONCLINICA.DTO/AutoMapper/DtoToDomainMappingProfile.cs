...
namespace Romsoft.GESTIONCLINICA.DTO.AutoMapper
{
    public class DtoToDomainMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<TABLAS.FAR_CLASE.FAR_CLASEDTO, Entidades.FAR_CLASE.FAR_CLASE>();

            Mapper.CreateMap<TABLAS.FAR_GENERICO.FAR_GENERICODTO, Entidades.FAR_GENERICO.FAR_GENERICO>();
            Mapper.CreateMap<TABLAS.FAR_FAMILIA.FAR_FAMILIADTO, Entidades.FAR_FAMILIA.FAR_FAMILIA>();

            Mapper.CreateMap<TABLAS.FAR_TIPO_PRODUCTO.FAR_TIPO_PRODUCTODTO, Entidades.FAR_TIPO_PRODUCTO.FAR_TIPO_PRODUCTO>();
            Mapper.CreateMap<TABLAS.FAR_TIPIFICACION.FAR_TIPIFICACIONDTO, Entidades.FAR_TIPIFICACION.FAR_TIPIFICACION>();
            Mapper.CreateMap< TABLAS.FAR_PRODUCTO.FAR_PRODUCTOReqDTO, Entidades.FAR_PRODUCTO.FAR_PRODUCTOReq>();
            Mapper.CreateMap<TABLAS.FAR_PRODUCTO.FAR_PRODUCTOResDTO, Entidades.FAR_PRODUCTO.FAR_PRODUCTORes>();
            Mapper.CreateMap<TABLAS.FAR_PRODUCTO.FAR_PRODUCTOByIdReqDTO, Entidades.FAR_PRODUCTO.FAR_PRODUCTOByIdReq>();
            Mapper.CreateMap<TABLAS.FAR_PRODUCTO.FAR_PRODUCTOByIdResDTO, Entidades.FAR_PRODUCTO.FAR_PRODUCTOByIdRes>();
            Mapper.CreateMap<TABLAS.FAR_CONSIGNACION.FAR_CONSIGNACIONDTO, Entidades.FAR_CONSIGNACION.FAR_CONSIGNACION>();
